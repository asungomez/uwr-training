...
import {
  ...
  ExerciseMetaSection,
} from '@/components/features/exercises/ExerciseDetailContent'
    ...
    <section>
      ...
      {data && (
        <div className="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-start">
          ...
          <ExerciseMediaSection exercise={data} />

          {/* Right: parameters, alternatives, and admin actions. */}
          <div className="flex flex-col gap-8">
            <ExerciseMetaSection exercise={data} />
