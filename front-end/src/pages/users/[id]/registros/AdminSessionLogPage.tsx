...
/** Admin read-only view of one of an athlete's gym/pool session logs, reached from
 *  the user's "Entrenamientos" tab. Same data as the athlete's own log detail, but
 *  without the week-editing control. */
function AdminSessionLogPage() {
    ...
    <section>
      ...
      {data && (
        <div className="mt-6 max-w-2xl">
          ...
          {training.data?.title && <p className="mt-1 text-slate-400">{training.data.title}</p>}
...
export default AdminSessionLogPage
